...
load_project_env()
DOUBAO_API_KEY = os.getenv("BOT_API_KEY", os.getenv("LLM_API_KEY", os.getenv("API_KEY", "")))
DOUBAO_BOT_URL = os.getenv("BOT_BASE_URL", os.getenv("BOT_URL", ""))
BOT_MODEL = os.getenv("BOT_MODEL", os.getenv("DEFAULT_CHAT_MODEL", "bot-20250227131955-snjfg"))
